export default function normaliseData(data, highestDate) {
  ...
  let highestDateUTC = Date.UTC(
    highestDateObj.getUTCFullYear(),
    highestDateObj.getUTCMonth(),
    highestDateObj.getUTCDate(),
  );
